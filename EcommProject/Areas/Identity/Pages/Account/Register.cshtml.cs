    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                  Name = Input.Name, //Input.Name kaa data TextBox se aaya or Name = Stored in Database,Database column name
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, SD.Role_Admin);  //Here user  is var user
                    ...
                    {
                        //if (Input.Role == (SD.Role_Individual) || Input.Role == "")
                        if (Input.Role == null && Input.CompanyId == null)
